...
//the leftArrow() fucntion will be executed when the user clicks the left navigation arrow button
...
//the rightArrow() funtion will execute when the user clicks the right naviagtion arrow
